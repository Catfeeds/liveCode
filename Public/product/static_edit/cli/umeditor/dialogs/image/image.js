...
//                }
        ...
        callback: function (editor, $w, url, state) {
            ...
            if (state == "SUCCESS") {
                //显示图片计数+1
                Upload.showCount++;
                var $img = $("<img src='"+STATIC_SERVICE+"/cli/umeditor/dialogs/image/" + editor.options.imagePath + url + "' class='edui-image-pic' />"),
    ...
    var Upload = {
        ...
        submit: function (callback) {
            ...
            $('.edui-image-file').click(function() {
                seajs.use([STATIC_SERVICE+'/public/upload.js', STATIC_SERVICE+'/cli/js/upload_um.js'], function(a, b) {
                    b.upload('product',0);
        ...
        initEvt: function () {
            ...
            $(".edui-image-searchAdd", me.dialog).on("click", function () {
                ...
                if (url) {
                    ...
                    $("<img src='"+STATIC_SERVICE+"/cli/umeditor/dialogs/image/" + url + "' class='edui-image-pic' />").on("load", function () {
