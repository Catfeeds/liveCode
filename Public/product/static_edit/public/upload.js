(function(){
	...
	var defaults={
		'exts' : 'jpg,jpeg,gif,png,bmp,pdf,doc,docx,ppt,pptx,vcf,pot,potx,xls,xlsx,txt,rtf,et,wps,dps,mp3,mp4,wma,mid,ifc,rvt,obj,dwg', //支持的扩展名
	...
	var log_errors = function(code,callback){
		loadScript(STATIC_SERVICE+"/public/base64.js",function(){
