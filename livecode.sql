...
INSERT INTO `fw_admin_menu` VALUES ('11', '4', '0', '活码生成', '2', 'Admin/Duourl/index', 'fa fa-list', '0', '1505210029', '1');
INSERT INTO `fw_admin_menu` VALUES ('12', '11', '3', '目录一', '2', 'Admin/Duourl/index', '', '0', '1505210029', '1');
...
CREATE TABLE `fw_admin_upload` (
  ...
  `status` tinyint(4) NOT NULL DEFAULT '0' COMMENT '状态',
  PRIMARY KEY (`id`)
) ENGINE=MyISAM AUTO_INCREMENT=26 DEFAULT CHARSET=utf8 COMMENT='文件上传表';
...
-- ----------------------------
INSERT INTO `fw_admin_user` VALUES ('1', '1', '超级管理员', 'admin', 'fd8814c421cef400460ba9863cbf8a59', '', '0', '', '0', '0', '0', '0.00', '0', '', '1438651748', '1501578198', '1', '1');
INSERT INTO `fw_admin_user` VALUES ('2', '1', '', '哈哈哈', 'a45f615149ce4ce2c7fca888fe043fcd', '', '0', '', '0', '0', '0', '0.00', '0', 'admin', '1496210259', '1505108530', '1', '1');
INSERT INTO `fw_admin_user` VALUES ('3', '2', '', '18121029523', 'a45f615149ce4ce2c7fca888fe043fcd', 'newbie91521@163.com', '0', '18121029523', '0', '0', '0', '0.00', '2130706433', 'admin', '1505117796', '1505119771', '1', '1');
